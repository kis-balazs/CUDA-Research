...
- MLFlow
    - Pretty much same thing as wandb above, open source and locally/self-hosted  
...
- [NVCC](https://docs.nvidia.com/cuda/cuda-compiler-driver-nvcc/)
    ...
    - Works on everything in the CUDA toolkit --> most helpful for Nvidia ecosystem
    
    ![Untitled](assets/nvcc.png)
        
## Misc
- Overall Speed Comparison between concepts discussed above (languages, frameworks, etc.)
![Untitled](assets/speed.png)
- Huggingface